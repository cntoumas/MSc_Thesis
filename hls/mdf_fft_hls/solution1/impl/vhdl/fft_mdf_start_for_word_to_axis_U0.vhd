...
entity fft_mdf_start_for_word_to_axis_U0 is 
    generic (
...
architecture rtl of fft_mdf_start_for_word_to_axis_U0 is

    component fft_mdf_start_for_word_to_axis_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_fft_mdf_start_for_word_to_axis_U0_ShiftReg : fft_mdf_start_for_word_to_axis_U0_ShiftReg
    generic map (
...
entity fft_mdf_start_for_word_to_axis_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end fft_mdf_start_for_word_to_axis_U0_ShiftReg;

architecture rtl of fft_mdf_start_for_word_to_axis_U0_ShiftReg is
