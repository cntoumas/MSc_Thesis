...
# 2 "<built-in>" 2
# 1 "serial_fft/fft_serial.cpp" 2
# 1 "./serial_fft/fft_serial.h" 1
...
# 4 "./serial_fft/fft_serial.h" 2

static const int FFT_N = 1024;
static const int FFT_LOG2_N = 10;
# 26 "./serial_fft/fft_serial.h"
__attribute__((sdx_kernel("fft_serial", 0))) void fft_serial(
    int16_t in_re [FFT_N],
    int16_t in_im [FFT_N],
...
# 2 "serial_fft/fft_serial.cpp" 2
# 1 "./serial_fft/../twiddle_rom.h" 1

# 1 "C:/Xilinx/Vitis_HLS/2023.2/common/technology/autopilot\\ap_int.h" 1
# 3 "./serial_fft/../twiddle_rom.h" 2
# 1 "./twiddle_lut.h" 1
...
# 4 "./serial_fft/../twiddle_rom.h" 2
# 19 "./serial_fft/../twiddle_rom.h"
...
# 45 "./serial_fft/../twiddle_rom.h"
inline void mdf_twiddle_get(int addr, int stage, int path, short* w_re, short* w_im) {
#pragma HLS INLINE
 int n = ((addr * 4) + path) << stage;
    twiddle_get(n, w_re, w_im);
}
# 3 "serial_fft/fft_serial.cpp" 2
# 19 "serial_fft/fft_serial.cpp"
...
#pragma HLS INLINE
 int r = 0;
    VITIS_LOOP_95_1: for (int i = 0; i < FFT_LOG2_N; i++) {
#pragma HLS UNROLL
 r = (r << 1) | (x & 1);
        x >>= 1;
    }
...
#line 13 "C:/Users/ntoum/Desktop/thesis_repo/hls/export_impl.tcl"
#pragma HLSDIRECTIVE TOP name=fft_serial
# 205 "serial_fft/fft_serial.cpp"
...
#pragma HLS PIPELINE II=1
 int j = bit_rev10(i);
    ...
    exponent += bfp_exp_delta(clz_next);
