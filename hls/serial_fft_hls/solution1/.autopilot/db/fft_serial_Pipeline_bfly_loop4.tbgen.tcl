set moduleName fft_serial_Pipeline_bfly_loop4
set isTopModule 0
...
set C_modelName {fft_serial_Pipeline_bfly_loop4}
...
set C_modelArgList {
	...
	{ or_mask_7_out int 8 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "re", "interface" : "memory", "bitwidth" : 17, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "or_mask_7_out", "interface" : "wire", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ or_mask_7_out sc_out sc_lv 8 signal 5 } 
	{ or_mask_7_out_ap_vld sc_out sc_logic 1 outvld 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "or_mask_7_out", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "or_mask_7_out", "role": "default" }} , 
 	{ "name": "or_mask_7_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "or_mask_7_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_mulsub_16s_16s_32s_32_3_1_U48", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_16s_32s_32_2_1_U49", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	or_mask_7_out { ap_vld {  { or_mask_7_out out_data 1 8 }  { or_mask_7_out_ap_vld out_vld 1 1 } } }
